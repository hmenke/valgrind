...
typedef  struct {  ZMM a1; ZMM a2; ZMM a3; ZMM a4; ULong u64; }  Block;
...
#define GEN_test_RandM(_name, _reg_form, _mem_form)   \
    ...
    { \
       ...
       __asm__ __volatile__( \
          "vmovdqa64   0(%0),%%zmm7"  "\n\t" \
          "vmovdqa64  64(%0),%%zmm8"  "\n\t" \
          "vmovdqa64 128(%0),%%zmm6"  "\n\t" \
          "vmovdqa64 192(%0),%%zmm9"  "\n\t" \
          "movq    256(%0),%%r14"   "\n\t" \
          _reg_form   "\n\t" \
          "vmovdqa64 %%zmm7,  0(%0)"  "\n\t" \
          "vmovdqa64 %%zmm8, 64(%0)"  "\n\t" \
          "vmovdqa64 %%zmm6,128(%0)"  "\n\t" \
          "vmovdqa64 %%zmm9,192(%0)"  "\n\t" \
          "movq    %%r14, 256(%0)"  "\n\t" \
          : /*OUT*/  \
          : /*IN*/"r"(b) \
...
GEN_test_RandM(VMOVUPS_ZMM_to_ZMMorMEM,
               "vmovups %%ymm8, %%ymm7",
               "vmovups %%ymm9, (%%rax)")
...
GEN_test_RandM(VMOVDDUP_ZMMorMEM256_to_ZMM,
               "vmovddup %%ymm8,  %%ymm7",
               "vmovddup (%%rax), %%ymm9")
...
int main ( void )
{
   ...
   DO_D( VMOVDDUP_ZMMorMEM256_to_ZMM );
